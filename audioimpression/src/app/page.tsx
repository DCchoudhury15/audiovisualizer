...
export default function HomePage() {
  ...
  const handleFileChange = async (
    ...
    reader.onload = async () => {
      try {
        ...
        // ✅ UPDATED with your specific inference URL
        const response = await fetch("https://dcchoudhury15--audio-cnn-inference-audioclassifier-inference.modal.run", {
          method: "POST",
  ...
  return (
    // ✅ UPDATED: Main background color and default text color
    <main className="min-h-screen bg-slate-900 p-8 text-slate-400">
      <div className="mx-auto max-w-[100%]">
        <div className="mb-12 text-center">
          <h1 className="mb-4 text-4xl font-light tracking-tight text-slate-200">
          ...
          <div className="flex flex-col items-center">
            ...
            {fileName && (
              <Badge
                variant="secondary"
                className="mt-4 bg-slate-700 text-slate-400"
              >
                {fileName}
              </Badge>
            )}
                ...
                <div className="grid grid-cols-5 gap-6">
                  {main.map(([mainName, mainData]) => (
                    <div key={mainName} className="space-y-4">
                      <div>
                        <h4 className="mb-2 font-medium text-slate-400">
                          {mainName}
                        </h4>
                        <FeatureMap
                      ...
                      {internals[mainName] && (
                        <div className="h-80 overflow-y-auto rounded border border-slate-700 bg-slate-900/80 p-2">
